...
import com.pb.vasylenko.hw11.TelephoneBook;
...
public class Main {
    public static void main(String[] args) {
        com.pb.vasylenko.hw11.TelephoneBook book = new com.pb.vasylenko.hw11.TelephoneBook();
        if (book.fromFile()) {
    ...
    private static boolean userChose(StringBuilder input, com.pb.vasylenko.hw11.TelephoneBook book, Scanner scanner) {
        try {
    ...
    private static void searchPerson(com.pb.vasylenko.hw11.TelephoneBook book, Scanner scanner) {
        System.out.print("Введите имя контакта  -> ");
        String personName = scanner.next().toUpperCase(Locale.ROOT).trim();
        viewing(new com.pb.vasylenko.hw11.TelephoneBook(book.getPersonsList().stream().filter(u -> u.getName().equals(personName)).collect(Collectors.toList())));
    }

    private static void sortPerson(com.pb.vasylenko.hw11.TelephoneBook book, Scanner scanner) {
    ...
    private static void showPersonsList(com.pb.vasylenko.hw11.TelephoneBook book) {
    ...
    private static com.pb.vasylenko.hw11.Person chosePerson(com.pb.vasylenko.hw11.TelephoneBook book, Scanner scanner) {
    ...
    private static void editingPerson(com.pb.vasylenko.hw11.TelephoneBook book, Scanner scanner) {
        com.pb.vasylenko.hw11.Person person = chosePerson(book, scanner);
        if (person != null) {
    ...
    private static void deletePerson(com.pb.vasylenko.hw11.TelephoneBook book, Scanner scanner) {
        com.pb.vasylenko.hw11.Person person = chosePerson(book, scanner);
        if (person != null) {
    ...
    private static void addPerson(com.pb.vasylenko.hw11.TelephoneBook book, Scanner scanner) {
